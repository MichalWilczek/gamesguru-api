...
class NeoNet(ShopMetadata):
    ...
    offer_box_name = "listingItemScss-root-1KP"
    price_box_name = "priceScss-root-QxQ"
    price_value_name = "uiPriceScss-integer-38D"
    price_currency_name = "uiPriceScss-currency-2wy"
...
def get_prices(box, metadata: ShopMetadata):
    try:
        ...
        price_element = box.find(class_=re.compile("price ta-price-tile"))
